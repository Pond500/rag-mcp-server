...
# ปิด tokenizers parallelism เพื่อหลีกเลี่ยง warning
...
LLM_API_BASE = os.getenv("LLM_API_BASE", "https://tokenmind.abdul.in.th/v1")
LLM_API_KEY = os.getenv("LLM_API_KEY", "sk-WIqY-Eg2u9q24jnZ9jbFHw")
