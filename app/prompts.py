...
from langchain_core.prompts import PromptTemplate # หรือ ChatPromptTemplate
...
THAI_QA_TEMPLATE = PromptTemplate(
    template=DEFAULT_THAI_QA_PROMPT_TMPL,
...
THAI_CONDENSE_TEMPLATE = PromptTemplate(
    template=DEFAULT_THAI_CONDENSE_TMPL,
...
METADATA_EXTRACTOR_TEMPLATE = PromptTemplate(
    template=DEFAULT_METADATA_EXTRACTOR_TMPL,
